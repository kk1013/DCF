            ...
            <div>
                ...
                <table class="joinform-table">
                    <tr class="joinform-tr">
                        ...
                        <td>
                            <input class="joinform-input" type="text" placeholder="자기이름" value="${dto.user_name}">
                        </td>
                    </tr>
                    <tr class="joinform-tr">
                        <td class="joinform-subtitle">
                        ...
                        <td class="btndiv">
                            <input class="joinform-input2" type="text" placeholder="자기아이디" value="${dto.user_id}" disabled>
                        </td>
                    </tr>
                    <tr class="joinform-tr">
                        <td class="joinform-subtitle">
                        ...
                        <td>
                            <input class="joinform-input" type="password" placeholder="비밀번호 입력" value="${dto.user_pw}"><br>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                    ...
                    <tr class="joinform-tr">
                        ...
                        <td>
                            <input class="joinform-input" type="email" placeholder="자기이메일@naver.com" value="${dto.user_email}"><br>
                        </td>
                    </tr>
                    ...
                    <tr class="joinform-tr">
                        ...
                        <td>
                            <input class="joinform-input" type="phone" placeholder="자기휴대폰번호 01055521000" value="0${dto.user_phone }">
                        </td>
                    </tr>
                </table>
                <table id="joinform-table">
                    <tr class="joinform-tr">
                        ...
                        <td>
                            <input class="joinform-input" type="text" placeholder="자기생일뜨게20000101" value="<fmt:formatDate value="${dto.user_birth_date}" pattern = "yyyyMMdd"/>">
                        </td>
                    </tr>
                    <tr class="joinform-tr">
                        <td class="joinform-subtitle">
                        ...
                        <td class="joinform-check2">
                            <input type="radio" name="checkBox2" id="yellowCheckbox2" class="checkinput" value="0" checked>
                    ...
                    <tr class="joinform-tr">
                        ...
                        <td>
                            <input class="joinform-input" type="text" placeholder="자기주소 의정부 부흥로25" value="${dto.user_address}">
                        </td>
                    </tr>
                </table>
