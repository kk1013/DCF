...
<div id="admin-product-wrap">
    ...
    <div>
    <form action="/admin_product_registration_form" method="post" enctype="multipart/form-data">
        <table id="category-table">
            ...
            <tr class="line-top line-bottom">
                <td class="item">
                    <input type="radio" name="feed-type" class="category-feed-type" value="0" checked>건식
        ...
        <table id="product-table">
            ...
            <tr class="line-top line-bottom">
                ...
                <td><input type="text" class="input-border" name="name" style="width: 100%; height: 35px; margin-right: 10px;"></td>
            </tr>
            <tr class="line-top line-bottom">
            ...
            <tr class="line-top line-bottom">
                ...
                <td class="KRW"><input type="text" class="input-border" name="price" style="height: 35px; margin-right: 10px;"><p>KRW</p></td>
            </tr>
            <tr class="line-top line-bottom">
        ...
        <div id="btn-box">
            <input type="submit" id="btn" value="상품등록">
        </div>
        </form>
    </div>
</div>
